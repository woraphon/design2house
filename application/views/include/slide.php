<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="item active">
	      	<img src="<?php echo base_url()?>images/slide/home1.jpg" alt="...">
	   		<div class="carousel-caption">
	      		<h3>Design To House</h3>
	   		</div>
	</div>
	<div class="item">
	      	<img src="<?php echo base_url()?>images/slide/home2.jpg" alt="...">
	    	<div class="carousel-caption">
	      		<h3>Design To House</h3>
	    	</div>
	</div>
	<div class="item">
	      	<img src="<?php echo base_url()?>images/slide/home3.jpg" alt="...">
	    	<div class="carousel-caption">
	      		<h3>Design To House</h3>
	    	</div>
	</div>
	<div class="item">
	      	<img src="<?php echo base_url()?>images/slide/home4.jpg" alt="...">
	    	<div class="carousel-caption">
	      		<h3>Design To House</h3>
	    	</div>
	</div>
